...
<main role="main">
  ...
  <section class="jumbotron bg-dark text-center">
    ...
    <form action="${pageContext.request.contextPath}/Filter" method="post">
        ...
        <select name="brand1" class="custom-select my-2">
          <option selected value="%a%"> Brand - 1 </option>
  ...
  <form action="${pageContext.request.contextPath}/Compare" method="post" >
      ...
      <c:forEach items="${getListBrand1}" var="mobile">
        ...
        <c:forEach items="${getListBrand2}" var="mobile">
        ...
        <div class="col-md-12">
          <div class="card mb-4 shadow-lg">
            <div class="card-body">
              ...
              <p class="card-text font-weight-bold font-italic text-muted">
               Price :	&#8377 ${ mobile.price }
              </p>
